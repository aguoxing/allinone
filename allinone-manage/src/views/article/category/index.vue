<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="categoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="主键" align="center" prop="categoryId" v-if="true"/>
...
<script>
import {addCategory, delCategory, exportCategory, getCategory, listCategory, updateCategory} from "@/api/article/category";
